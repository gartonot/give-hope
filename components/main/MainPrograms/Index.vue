  ...
  const programList = [
    {
      ...
      title: 'Пожилым людям',
      description:
        'Программа направлена на организацию досуговых мероприятий в домах-интернатах для престарелых и инвалидов.',
    ...
    },
    {
      ...
      description:
        'Программа фонда направлена на создание достойных и безопасных условий для проживания пожилых людей и инвалидов, которые находятся в государственных домах-интернатах и отделениях сестринского ухода.',
    ...
    },
    {
      ...
      title: 'Дари ремонт',
      description:
        '«Дари Ремонт» – программа фонда направлена на создание безопасных и комфортных условий для проживания пожилых людей и инвалидов.',
  ...
  <section class="programs">
    <div class="container programs__container">
      ...
      <img
        ...
        alt="Glasses"
      />
      <app-headline label="Программы фонда" class="programs__title" />
