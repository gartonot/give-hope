<script lang="ts" setup>
  ...
  const programList = [
    ...
    },
    {
      ...
      description:
        'Программа фонда, направленная на создание достойных и безопасных условий для проживания пожилых людей и инвалидов, которые находятся в государственных домах-интернатах и отделениях сестринского ухода.',
    ...
    },
    {
      ...
      title: 'Дари ремонт',
      description:
        '«Дари Ремонт» – программа фонда , направленная на создание безопасных и комфортных условий для проживания пожилых людей и инвалидов.',
