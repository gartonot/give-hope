...
<template>
  <div class="privacy-policy">
    <div class="container">
      <h1 class="privacy-policy__title">Политика в отношении обработки персональных данных</h1>
      <div class="privacy-policy__content">
        <strong>1. Общие положения</strong><br /><br />Настоящая политика обработки персональных
        данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. №152-ФЗ
        «О персональных данных» и определяет порядок обработки персональных данных и меры по
        обеспечению безопасности персональных данных
        <strong>Горяиновой Анастасии Александровны</strong> (далее – Оператор).<br /><br />
        <ol>
          <li>
          ...
          <li>
            ...
            веб-сайта
            <a href="http://darinadezhdu.org/"><strong>http://darinadezhdu.org/</strong></a>
          </li>
        </ol>
        <br /><br /><strong>2. Основные понятия, используемые в Политике</strong><br /><br />
        <ol>
          <li>
          ...
          <li>
            ...
            <a href="http://darinadezhdu.org/">http://darinadezhdu.org/</a>;
          </li>
          <li>
        ...
        <br /><br /><strong
          >3. Оператор может обрабатывать следующие персональные данные Пользователя</strong
        ><br /><br />
        <ol>
          ...
          <li>Телефон;</li>
          <li>
            Для получения обратной связи о работе сервиса, сайта, улучшения обслуживания и
          ...
          <li>
            Также на сайте происходит сбор и обработка любых данных, которые пользователь
            предоставляет по собственному желанию и усмотрению.
          </li>
          <li>
        ...
        <br /><br /><strong>4. Цели обработки персональных данных</strong><br /><br />
        <ol>
          <li>
          ...
          <li>
            ...
            электронной почты darinadezhduu@gmail.com с пометкой «Отказ от уведомлениях о новых
        ...
        <br /><br /><strong>5. Правовые основания обработки персональных данных</strong><br /><br />
        <ol>
          <li>
            ...
            сайте <a href="http://darinadezhdu.org/">http://darinadezhdu.org/</a>. Заполняя
        ...
        <br /><br /><strong
          >6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</strong
        ...
        <ol>
          ...
          <li>
            ...
            Оператора darinadezhduu@gmail.com с пометкой «Актуализация персональных данных».
          </li>
          <li>
            ...
            darinadezhduu@gmail.com с пометкой «Отзыв согласия на обработку персональных данных»
          </li>
        </ol>
        <br /><br /><strong>7. Трансграничная передача персональных данных</strong><br /><br />
        <ol>
          <li>
        ...
        <br /><br /><strong>8. Заключительные положения</strong><br /><br />
        <ol>
          <li>
          ...
          <li>
            ...
            <a href="http://darinadezhdu.org/personaldatapolicy"
              >http://darinadezhdu.org/personaldatapolicy</a
            ><br />
            <ol></ol>
          </li>
        </ol>
